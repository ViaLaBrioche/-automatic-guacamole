const {By, until} = require("selenium-webdriver");
 ...
 async function test4({driver, accountSelection, accountDebitName, accountCreditName, waitingFinishOperation, amount}) {
    ...
    await driver.wait(until.elementLocated(By.xpath('//*[@id="j_id_5e_3j:serviceWarningDlg:serviceWarningDlg:j_id_5e_45"]')), 20000);
    await console.log(8)
    //Нажимаем кнопку Да
