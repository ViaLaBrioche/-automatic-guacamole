const {By, until, Key} = require("selenium-webdriver");
 ...
 async function test2(driver) {
    ...
    await driver.findElement(By.xpath("//*[@id='dropdown_CREDIT_CURRENCY']/div-tag[2]/a[77]")).click();
    //Находим выпадающий список Списать с
    await driver.findElement(By.id("dropdown_DEBIT_CURRENCY")).click();
    //Выбираем счет списания
    await driver.findElement(By.xpath("//*[@id='dropdown_DEBIT_CURRENCY']/div-tag[2]/a[60]")).click();
    ...
    await driver.wait(until.elementLocated(By.id('j_id_5e_uv:sendBtn'), 10000));
